...
class BasicTestCase(unittest.TestCase):
    def test_index(self):
        """Initial test: confirm Flask was set up correctly."""
...
class FlaskrTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        """Destroy the blank temp database after each test."""
        os.close(self.db_fd)
    ...
    def test_delete_messages(self):
        """Ensure that a user can delete messages."""
